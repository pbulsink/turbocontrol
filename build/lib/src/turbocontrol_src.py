...
from src.turbogo_src import jobrunner, check_input_file, submit_script_prepare
from src.turbogo_src import JobLogicError, submit_job
...
import logging
import argparse
from src.screwer_op import Screwer
from src.freeh_op import Freeh, proc_freeh
...
try:
    ...
    from src.formatter import convert_filetype
    reformat = True
